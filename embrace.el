...
(cl-defstruct embrace-pair-struct
  key left right left-regexp right-regexp read-function help)
...
(defun embrace-add-pair (key left right &optional help)
...
(defun embrace-add-pair-regexp
    (key left-regexp right-regexp read-function &optional help)
  (assq-delete-all key embrace--pairs-list)
  (add-to-list 'embrace--pairs-list
               (cons key (make-embrace-pair-struct
                          :key key
