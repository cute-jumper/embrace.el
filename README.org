...
** Why not use together?
   ...
   all the other keys will be processed by =embrace=. You can customize
   =embrace= in the way described in the previous *Customization* section to add
   support for additional pairs.
